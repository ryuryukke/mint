...
def from_pretrained(cls, model_name, kwargs, cache_dir):
    ...
    obj = cls.from_pretrained(
        model_name, **kwargs, cache_dir=cache_dir, device_map="auto"
    )
...
model_fullnames = {
    ...
    "pythia-12b-dedup": "EleutherAI/pythia-12b-deduped",
}
float16_models = [
    "gpt-j-6B",
    "gpt-neox-20b",
...
def load_tokenizer(model_name, for_dataset, cache_dir):
    ...
    base_tokenizer = AutoTokenizer.from_pretrained(
        model_fullname, **optional_tok_kwargs, cache_dir=cache_dir, device_map="auto")
