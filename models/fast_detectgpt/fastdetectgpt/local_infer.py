...
class FastDetectGPTModel:
    def __init__(
        ...
        if self.scoring_model_name == "facebook/opt-125m":
            self.scoring_tokenizer.model_max_length = 2048
        elif "Llama-3" in self.scoring_model_name:
            self.scoring_tokenizer.model_max_length = 4096
        elif "Llama-2" in self.scoring_model_name:
            self.scoring_tokenizer.model_max_length = 4096
        elif "mpt" in self.scoring_model_name:
            self.scoring_tokenizer.model_max_length = 512
        elif "gpt2" in self.scoring_model_name:
            self.scoring_tokenizer.model_max_length = 1024
        elif "pythia" in self.scoring_model_name:
            self.scoring_tokenizer.model_max_length = 2048
        ...
        if self.reference_model_name != self.scoring_model_name:
            ...
            if self.reference_model_name == "facebook/opt-125m":
                self.reference_tokenizer.model_max_length = 2048
            elif "Llama-3" in self.reference_model_name:
                self.reference_tokenizer.model_max_length = 4096
            elif "Llama-2" in self.reference_model_name:
                self.reference_tokenizer.model_max_length = 4096
            elif "mpt" in self.reference_model_name:
                self.reference_tokenizer.model_max_length = 512
            elif "gpt2" in self.reference_model_name:
                self.reference_tokenizer.model_max_length = 1024
            elif "pythia" in self.reference_model_name:
                self.reference_tokenizer.model_max_length = 2048
